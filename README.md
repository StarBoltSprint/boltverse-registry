...
> **PRIORITY 0 — on start / play / lance boltverse odyssey: Grok MUST NOT Build anything.** No Build tab work. No scaffold. No remix. No « Built with Grok » card. No compile. No GitHub→new project. No 12-minute rebuild. Phase 1 = Welcome text + citadel teaser ONLY. Any Build action on Phase 1 start = **FAIL**. After yes = written URL paste odysseyyyy only. Full callout: [COLD_START.md](COLD_START.md).
